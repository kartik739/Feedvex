      ...
      <main style={{
        ...
        <section>
          ...
          <div style={{
            ...
            <span style={{ fontSize: '11px', fontWeight: 600, color: '#4edea3', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              12M+ Threads Indexed
            </span>
          </div>
          ...
          <h1 style={{
            ...
            The Terminal{' '}
            <em style={{ color: '#4edea3', fontStyle: 'italic' }}>for</em>{' '}
            Human Knowledge.
          </h1>
          ...
          <p style={{
            ...
            We index developer Reddit threads so you can search them in milliseconds — even after they're deleted.
          </p>
          ...
          <form onSubmit={handleSearch} style={{ maxWidth: '480px' }}>
            ...
            >
              ...
              <input
                ...
                placeholder={isSignedIn ? 'Search Reddit for technical answers...' : 'Sign up to search...'}
                style={{
                  flex: 1,
          ...
          {!isSignedIn && (
            <p style={{ fontSize: '13px', color: '#555', marginTop: '16px' }}>
              ...
              <button
                onClick={() => openSignIn()}
                style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#4edea3', fontSize: '13px', padding: 0, fontFamily: 'inherit' }}
              >
                Sign in
              </button>
            </p>
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: '11px', color: '#444', letterSpacing: '0.05em', textTransform: 'uppercase', fontWeight: 600 }}>
...
function StatCard({ value, label, live }: { value: string; label: string; live?: boolean }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: '11px', color: '#555', fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase' }}>
        {label}
      </div>
    </div>
  );
