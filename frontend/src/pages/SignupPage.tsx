        ...
        <SignUp
          ...
          appearance={{
            ...
            elements: {
              ...
              formButtonPrimary:
                'bg-amber-500 text-black font-semibold hover:bg-amber-400 transition-colors uppercase tracking-widest text-[10px] py-3',
              footerActionLink: 'text-amber-500 hover:text-amber-400',
              formFieldInput:
                'border-white/10 focus:border-amber-500 bg-[#1A1A1A] text-white rounded-sm',
